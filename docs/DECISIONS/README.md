...
- [ADR-0005: External links and Apple Books](0005-external-links-and-apple-books.md) — Accepted; Prompt 9 production implementation is awaiting independent review
- [ADR-0006: Sandboxed file access](0006-sandboxed-file-access.md) — Accepted; Prompt 7 write destinations are extended by ADR-0008 and Prompt 9 bookmark implementation is awaiting independent review
