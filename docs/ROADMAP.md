...
feature or automatic update work. P12-RELEASE-FINAL subsequently authorized
the specific v1.2.0 remote publication, completed on 2026-09-10.
...
Mac's downloaded-app Gatekeeper flow remain unverified. The formal Release and
public-download checksum verification are complete; support is M-series/macOS 26.0+
only. Post-publication documentation and the complete pending-change review remain owner Git actions.
